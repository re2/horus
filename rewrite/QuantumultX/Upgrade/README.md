...
https://raw.githubusercontent.com////rewrite/QuantumultX/Upgrade/Upgrade.conf

稳定版：

https://raw.githubusercontent.com///release/rewrite/QuantumultX/Upgrade/Upgrade.conf
...
欢迎通过[issues](https://github.com///issues/new)提交反馈，共同完善本项目的更新检查复写规则。
