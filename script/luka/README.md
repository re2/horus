...
https://raw.githubusercontent.com/codetracer/horus/master/script/luka/luka_signin.sgmodule
...
```ini
[Remote Script]
https://raw.githubusercontent.com/codetracer/horus/master/script/luka/luka_signin.lnscript, tag=Luka_每日签到, enabled=true
```
...
```ini
[rewrite_remote]
https://raw.githubusercontent.com/codetracer/horus/master/script/luka/luka_signin.qxrewrite, tag=Luka_获取Cookie, enabled=true

[task_local]
15 0 * * * https://raw.githubusercontent.com/codetracer/horus/master/script/luka/luka_signin.js, tag=Luka_每日签到, enabled=true
```
