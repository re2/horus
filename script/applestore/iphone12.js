...
const IPHONE_STOCK_KEY = 'iphone12_stock';
...
// 只能用来监控iPhone 12系列的库存，iPhone12 Pro的库存数据源不一样，不能用这个脚本
// 配置错误可能导致脚本运行不正常！
let TARGET_IPHONE = {
  "MGGY3CH/A": ["R359", "R705", "R389", "R390", "R401", "R705", "R683", "R581"],
  "MGH53CH/A": ["R359", "R705", "R389", "R390", "R401", "R705", "R683", "R581"],
  "MGGW3CH/A": ["R359", "R705", "R389", "R390", "R401", "R705", "R683", "R581"],
  "MGH33CH/A": ["R359", "R705", "R389", "R390", "R401", "R705", "R683", "R581"]
}
...
function getiPhoneProStock(){
  return new Promise(resolve=>{
    magicJS.get('https://reserve-prime.apple.com/CN/zh_CN/reserve/A/availability.json', (err, resp, data) =>{
...
async function Main(){
  ...
  let availability = await getiPhoneStock();
    ...
    for (let model in TARGET_IPHONE){
      ...
      for (let store of TARGET_IPHONE[model]){
        ...
        if (!stock.hasOwnProperty(model)){
          stock[model] = {name: TARGET_IPHONE[model]['name'], stores: {}};
        }
