...
https://raw.githubusercontent.com/codetracer/horus/master/script/eleme/eleme_daily.sgmodule
...
```ini
[Remote Script]
https://raw.githubusercontent.com/codetracer/horus/master/script/eleme/eleme_daily.lnscript, tag=饿了么_领取吃货豆及任务, enabled=true
```
...
```ini
[rewrite_remote]
https://raw.githubusercontent.com/codetracer/horus/master/script/eleme/eleme_daily.qxrewrite, tag=饿了么_获取Cookie, enabled=true

[task_local]
10 00 * * * https://raw.githubusercontent.com/codetracer/horus/master/script/eleme/eleme_daily.js, tag=饿了么_领取吃货豆, enabled=true
00 10 * * * https://raw.githubusercontent.com/codetracer/horus/master/script/eleme/eleme_mission.js, tag=饿了么_领取会员任务, enabled=true
```
