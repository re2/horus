...
```ini
[rewrite_remote]
https://raw.githubusercontent.com/codetracer/horus/master/script/10010/unicom_checkin.quanx, tag=联通_获取cookie, update-interval=86400, opt-parser=false, enabled=true
